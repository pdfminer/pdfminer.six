...
class PDFFont:
    ...
    def __init__(self, descriptor, widths, default_width=None):
        ...
        # Ascent: The maximum height above the baseline reached by glyphs in this font,
        # excluding the height of glyphs for accented characters.
        # Descent: The maximum depth below the baseline reached by glyphs in this font. The value
        # is a negative number.
        # Units are in 'glyph space'
        ...
        if self.descent == self.ascent == 0:
          ...
          # Note: this was designed to handle a special case where PDFs generated by Chrome are
          #  not following the official PDF spec.
